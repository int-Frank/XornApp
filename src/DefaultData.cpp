  ...
  , renderData{}
{
  ...
  renderData.polygonAspect[HS_Active].colour = 0xFFFFFFFF;
  renderData.polygonAspect[HS_Active].thickness = 2.2f;
  ...
  renderData.rotateWidgetAspect[HS_Active].colour = 0xFFFFFFFF;
  renderData.rotateWidgetAspect[HS_Active].anchorRadius = 3.f;
  renderData.rotateWidgetAspect[HS_Active].buttonRadius = 25.f;
  renderData.rotateWidgetAspect[HS_Active].lineThickness = 1.5f;
